module.exports = (app) => {
    const { userLogin, registerUser, getCurrentUser, updateUser, increaseCoins, buySkin, savePoints, getRanking, getUser, buyHammer } = require('../controllers/auth.controller.js');
    ...
    app.put('/user/buy/hammer', verifyJWT, buyHammer);
